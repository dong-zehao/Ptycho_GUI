function [m, rotation]=ReadDM4File_4D(filename,logfile)
...
celltags={
    'ImageList 4 ImageData Dimensions 1'
    'ImageList 4 ImageData Dimensions 2'
    'ImageList 4 ImageData Dimensions 3'
    'ImageList 4 ImageData Dimensions 4'
    'ImageList 4 ImageData Data'
    'ImageList 2 ImageTags DigiScan Rotation'};
...
dim3=output{3};
dim4=output{4};
m=reshape(output{5},[dim1 dim2 dim3 dim4]);
rotation = output{6};
